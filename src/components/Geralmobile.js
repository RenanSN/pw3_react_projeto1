...
function Geralmobile(props){
    ...
    if(props.titulo === "Android"){
        ...
        var titulo1 = <h5>Android Studio</h5>
        ...
        var titulo1 = <h5>React Native</h5>
