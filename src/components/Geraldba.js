...
function Geraldba(props){
    if(props.titulo === "Relacional"){
        var imagem1 = <img src={Mysql}/>
        var titulo1 = <h5>MySQL</h5>
        ...
        var imagem2 = <img src={Sqlserve}/>
        var titulo2 = <h5>SQL Server</h5>
        ...
        var imagem3 = <img src={Postgresql}/>
        var titulo3 = <h5>PostgreSQL</h5>
        ...
        var imagem4 = <img src={Sqlite}/>
        var titulo4 = <h5>SQLite</h5>
        ...
        var imagem1 = <img src={Mongodb}/>
        var titulo1 = <h5>MongoDB</h5>
        ...
        var imagem2 = <img src={Firebase}/>
        var titulo2 = <h5>Firebase</h5>
        ...
        var imagem3 = <img src={Dynamobd}/>
        var titulo3 = <h5>Amazon DynamoDB</h5>
        ...
        var imagem4 = <img src={Cassandra}/>
        var titulo4 = <h5>Apache Cassandra</h5>
